...
var kedvencek = document.getElementById("kedvencek");
var kedvencekgomb = document.getElementById("kedvenc");
var idezetekmezo = document.getElementById("idezetek");
var idezethely = document.getElementById("idezet");
var szerzohely = document.getElementById("szerzohely");


idezethely.innerText = idezetek[0].idezet;
szerzohely.innerText = idezetek[0].szerzo;
elozo.addEventListener('click', function(){
    if (hely != 0){
        hely = hely-1;
        idezethely.innerText = "";
        szerzohely.innerText = "";
        idezethely.innerHTML = idezetek[hely].idezet;
        szerzohely.innerHTML = idezetek[hely].szerzo;
...
kedvencekgomb.addEventListener('click', function(){
    ...
    container.appendChild(kedvencszerzo);
    kedvencek.appendChild(container)
})